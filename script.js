...
// sum button
const sumBtn = document.querySelector("#sumProduct");

sumBtn.onclick = () => {
  const priceSum = products.reduce((sum, { price }) => sum + Number(price), 0);
  const p = document.createElement("p");
  p.innerText = `сумма всех продуктов ровна ${priceSum}`;
